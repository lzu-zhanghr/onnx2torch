...
class OnnxGlobalAveragePool(
    ...
    def forward(
        ...
        if torch.onnx.is_in_onnx_export():
            return _GlobalAveragePoolExportToOnnx.set_forward_and_apply(
                _forward, input_tensor
            )
...
class OnnxGlobalAveragePoolWithKnownInputShape(
    ...
    def forward(
        ...
        if torch.onnx.is_in_onnx_export():
            return _GlobalAveragePoolExportToOnnx.set_forward_and_apply(
                forward_lambda, input_tensor
            )

        return forward_lambda()


class _GlobalAveragePoolExportToOnnx(
    CustomExportToOnnx
